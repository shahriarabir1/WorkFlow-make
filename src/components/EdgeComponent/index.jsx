...
const EdgeComponent = (props) => {
  ...
  return (
    ...
    >
      ...
      {isHovered() && (
        <g
          class="cursor-pointer pointer-events-auto transition-all ease-linear duration-100"
        ...
        >
          ...
          <g onMouseDown={handleOnClickDelete}>
            ...
            <svg
              ...
              height="24"
              viewBox="0 0 448 512"
              class="w-[22px] h-[22px] bg-white fill-black"
            >
          ...
          {/* Plus Button */}
          <g transform="translate(30, 0)" onMouseDown={handleOnClickAdd}>
            <circle class={styles.circle} />
            <svg
              fill="currentColor"
              stroke-width="0"
